...
public class BookDirectoryTestSuite {
    ...
    //Tests for verification before implementation

    @Test
    public void testNoneBorrowedBooks() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        // When
        List<Book> theListOfBooks = bookLibrary.listBookInHandsOf(libraryUser);

        //Then
        assertEquals(resultListOfZeroBooks.size(),theListOfBooks.size());
        verify(libraryDatabaseMock,times(1)).listBooksInHandsOf(libraryUser);
    }

    @Test
    public void testOneBorrowedBook() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        //Then
        assertEquals(resultListOfOneBook.size(),theListOfBooks.size());
        verify(libraryDatabaseMock,times(1)).listBooksInHandsOf(libraryUser);
    }

    @Test
    public void testFiveBorrowedBooks() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        //Then
        assertEquals(resultListOfFiveBooks.size(),theListOfBooks.size());
        verify(libraryDatabaseMock,times(1)).listBooksInHandsOf(libraryUser);
    }
